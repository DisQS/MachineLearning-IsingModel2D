...
-Lose the directory for Ising Data, write and read directly in the current directory. 
-Read data to return two numpy arrays: configurations and labels; so that we are ready to start with machine learning.
